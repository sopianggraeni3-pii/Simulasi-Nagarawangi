...
export const VEHICLE_TYPES = {
  car: {
    id: 'car',
    length: 5.0,          // metres (world units) - increased from 4.5
    width: 2.2,           // metres - increased from 2.0
    maxAccel: 2.0,        // m/s²
    comfortDecel: 3.0,    // m/s² (comfortable braking)
    maxDecel: 8.0,        // m/s² (emergency braking)
    desiredSpeed: 11.0,   // m/s ≈ 40 km/h (in-city)
    minGap: 3.8,          // s0 — minimum bumper-to-bumper gap (m) - increased to 3.8 for anti-collision
    timeHeadway: 1.5,     // T — desired time gap (s)
    weight: 0.55,         // spawn probability weight
    colors: ['#2563eb', '#1d4ed8', '#3b82f6', '#1e40af', '#60a5fa'],
    renderH: 20, renderW: 11,  // canvas px base dimensions
  },
  motorcycle: {
    id: 'motorcycle',
    length: 1.8,          // metres - decreased from 2.2
    width: 0.7,           // metres - decreased from 0.9
    maxAccel: 3.0,
    comfortDecel: 4.0,
    maxDecel: 9.0,
    desiredSpeed: 13.0,
    minGap: 1.8,          // s0 - increased to 1.8 for safe follow
    timeHeadway: 1.0,
    weight: 0.28,
    colors: ['#7c3aed', '#8b5cf6', '#6d28d9', '#a78bfa'],
    renderH: 9, renderW: 4.5,
  },
  angkot: {
    id: 'angkot',
    length: 6.0,
    ...
    maxDecel: 7.0,
    desiredSpeed: 9.0,
    minGap: 4.2,          // s0 - increased to 4.2
    timeHeadway: 2.0,
    weight: 0.11,
  ...
  truck: {
    ...
    maxDecel: 6.0,
    desiredSpeed: 8.0,
    minGap: 5.5,          // s0 - increased to 5.5
    timeHeadway: 2.5,
    weight: 0.06,
